...
export default class Menu extends THREE.Group {
  width: number;
  height: number;
  ...
  private async initialize() {
    ...
    const bottomLeft = await this.createTileMesh(
      texture,
      tileRow * 2,
      tileCol * 2,
      13 * 2,
    ...
    const bottomRight = await this.createTileMesh(
      texture,
      tileRow * 2,
      tileCol * 2 + 1,
      13 * 2,
    ...
    const bottomMiddle = await this.createTileMesh(
      texture,
      tileRow * 2,
      tileCol * 32 + 16,
      13 * 32,
    ...
    const topLeft = await this.createTileMesh(
      texture,
      tileRow * 2 + 1,
      tileCol * 2,
      13 * 2,
    ...
    const topRight = await this.createTileMesh(
      texture,
      tileRow * 2 + 1,
      tileCol * 2 + 1,
      13 * 2,
    ...
    const topMiddle = await this.createTileMesh(
      texture,
      tileRow * 2 + 1,
      tileCol * 32 + 16,
      13 * 32,
    ...
    const middleLeft = await this.createTileMesh(
      texture,
      tileRow * 32 + 16,
      tileCol * 2,
      13 * 2,
    ...
    const middleRight = await this.createTileMesh(
      texture,
      tileRow * 32 + 16,
      tileCol * 2 + 1,
      13 * 2,
    ...
    const middleMiddle = await this.createTileMesh(
      texture,
      tileRow * 32 + 16,
      tileCol * 32 + 16,
      13 * 32,
